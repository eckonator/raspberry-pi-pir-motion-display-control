...
curl -O https://raw.githubusercontent.com/eckonator/raspberry-pi-pir-motion-display-control/main/motion-display-control.py
curl -O https://raw.githubusercontent.com/eckonator/raspberry-pi-pir-motion-display-control/main/motion-display-control.service
